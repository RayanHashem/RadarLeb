...
class MobileWinnersPage extends Page implements HasTable
{
    use InteractsWithTable;

    protected static ?string $navigationIcon = 'heroicon-o-trophy';

    protected static ?string $navigationLabel = 'Mobile Winners';
    ...
    public function table(Table $table): Table
    {
        if (static::$cachedGame === null) {
            static::$cachedGame = Game::find(1); // Mobile game_id = 1
        }
    ...
    {
        return 'Mobile Winners';
    }

    public static function getRoutePath(): string
    {
        return '/winners/mobile';
    }
}
