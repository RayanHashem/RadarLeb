...
class BikeElectronicsWinnersPage extends Page implements HasTable
{
    use InteractsWithTable;

    protected static ?string $navigationIcon = 'heroicon-o-trophy';

    protected static ?string $navigationLabel = 'Bike & Electronics Winners';
    ...
    public function table(Table $table): Table
    {
        if (static::$cachedGame === null) {
            static::$cachedGame = Game::find(2); // Bike electronics game_id = 2
        }
    ...
    {
        return 'Bike & Electronics Winners';
    }

    public static function getRoutePath(): string
    {
        return '/winners/bike-electronics';
    }
}
