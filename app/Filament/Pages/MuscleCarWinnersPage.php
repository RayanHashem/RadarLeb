...
class MuscleCarWinnersPage extends Page implements HasTable
{
    use InteractsWithTable;

    protected static ?string $navigationIcon = 'heroicon-o-trophy';

    protected static ?string $navigationLabel = 'Muscle Car Winners';
    ...
    public function table(Table $table): Table
    {
        if (static::$cachedGame === null) {
            static::$cachedGame = Game::find(4); // Muscle car game_id = 4
        }
    ...
    {
        return 'Muscle Car Winners';
    }

    public static function getRoutePath(): string
    {
        return '/winners/muscle-car';
    }
}
